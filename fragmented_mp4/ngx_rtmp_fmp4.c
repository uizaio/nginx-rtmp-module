 ...
 **/
static ngx_int_t
ngx_rtmp_fmp4_field_64(ngx_buf_t *b, uint64_t n){
    u_char bytes[8];
...
/**
 * Write to a bit-array with specific length
 **/
static ngx_int_t
...
ngx_int_t
ngx_rtmp_fmp4_write_styp(ngx_buf_t *b)
{
    u_char  *pos;
...
// http://www.ramugedia.com/mp4-container
static ngx_int_t
ngx_rtmp_fmp4_write_mehd(ngx_buf_t *b){
    u_char *pos;
    pos = ngx_rtmp_fmp4_start_box(b, "mehd");
    /**Duration of all frames**/
    // FIXME: do we need to add this field?
    ngx_rtmp_fmp4_field_64(b, 0);
    ngx_rtmp_fmp4_update_box_size(b, pos);
...
static ngx_int_t
ngx_rtmp_fmp4_write_tkhd(ngx_rtmp_session_t *s, ngx_buf_t *b,
...
static ngx_int_t
ngx_rtmp_fmp4_write_hdlr(ngx_buf_t *b, ngx_rtmp_fmp4_track_type_t ttype)
{
    u_char  *pos;
    ...
    if (ttype == NGX_RTMP_FMP4_VIDEO_TRACK) {
        ...
        ngx_rtmp_fmp4_data(b, "Uiza SoundHandler", sizeof("Uiza SoundHandler"));
    }
...
static ngx_int_t
ngx_rtmp_fmp4_write_video(ngx_rtmp_session_t *s, ngx_buf_t *b)
{
    u_char                *pos;
    ngx_rtmp_codec_ctx_t  *codec_ctx;
...
static ngx_int_t
ngx_rtmp_fmp4_write_audio(ngx_rtmp_session_t *s, ngx_buf_t *b)
{
    u_char                *pos;
    ngx_rtmp_codec_ctx_t  *codec_ctx;
...
static ngx_int_t
ngx_rtmp_fmp4_write_stsd(ngx_rtmp_session_t *s, ngx_buf_t *b,
    ngx_rtmp_fmp4_track_type_t ttype)
{
    u_char  *pos;
    ...
    ngx_rtmp_fmp4_track_type_t ttype)
{
    ...
    ngx_rtmp_fmp4_write_stsd(s, b, ttype);
...
static ngx_int_t
ngx_rtmp_fmp4_write_minf(ngx_rtmp_session_t *s, ngx_buf_t *b,
    ngx_rtmp_fmp4_track_type_t ttype)
{
    u_char  *pos;
...
static ngx_int_t
ngx_rtmp_fmp4_write_mdia(ngx_rtmp_session_t *s, ngx_buf_t *b,
    ngx_rtmp_fmp4_track_type_t ttype)
{
    u_char  *pos;
    ...
    ngx_rtmp_fmp4_write_hdlr(b, ttype);
    ngx_rtmp_fmp4_write_minf(s, b, ttype);
...
static ngx_int_t
ngx_rtmp_fmp4_write_trak(ngx_rtmp_session_t *s, ngx_buf_t *b,
    ngx_rtmp_fmp4_track_type_t ttype)
{
    u_char  *pos;
    ...
    ngx_rtmp_fmp4_write_tkhd(s, b, ttype);
    ngx_rtmp_fmp4_write_mdia(s, b, ttype);
...
ngx_rtmp_fmp4_write_moov(ngx_rtmp_session_t *s, ngx_buf_t *b)
{
    ...
    ngx_rtmp_fmp4_write_trak(s, b, NGX_RTMP_FMP4_VIDEO_TRACK);
    ngx_rtmp_fmp4_write_trak(s, b, NGX_RTMP_FMP4_AUDIO_TRACK);
    ngx_rtmp_fmp4_update_box_size(b, pos);
